...
public class StatsManager{
    ...
    void registerListeners(){
        ...
        if (isUhcServer){
            ...
            PlayerDamageHandler playerDamageHandler = GameManager.getGameManager().getPlayerDamageHandler();
            assert playerDamageHandler != null;
            Bukkit.getPluginManager().registerEvents(new UhcStatListener(this, playerManager, playerDamageHandler), UhcStats.getPlugin());
        }
    }
    ...
    void createTable(GameMode gameMode){
        ...
        databaseConnector.createTable(
                ...
                new DatabaseColumn("score", DatabaseColumn.DataType.INT)
        );
    }
